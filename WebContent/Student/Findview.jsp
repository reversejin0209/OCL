		...
		<div class="login-html">
		    ...
		    <div class="login-form">
		      <div class="sign-in-htm">
		        ...
		        <div class="group">
		          <input type="submit" class="button" value="아이디 찾기" formaction="${conPath }/findID.do">
		          	<c:if test="${not empty student.sid}">
		          		<script>
							alert('찾으시는 아이디는 ${student.sid}입니다');
						</script>
		          	</c:if>
		        </div>
		        <div class="group">
		        ...
		        <div class="group">
		        <div class="group">
		          <input type="button" class="button" value="비밀번호 찾으러 가기" 
